...
const Footer = () => {
  ...
  <i class="fa-brands fa-github"></i>
      ...
      <a href="https://www.linkedin.com/in/hitesh-verma-3695b0254/"><i class="fa-brands fa-linkedin"></i></a>
      <a href="https://x.com/hitesh_404"><i class="fa-brands fa-twitter"></i></a>
    </div>
    <ul class="list">
